...
/**
 * CartDrawer — sidebar lateral derecho con líneas del carrito.
 *
 * - Slide-in animado con backdrop oscuro.
 * - Bloquea scroll del body cuando está abierto.
 * - ESC cierra.
 * - "Pagar" lleva al checkoutUrl de Shopify (URL hosteada, ahí ocurre
 *   todo el flujo de pago).
 *
 * Visual: bg crema, líneas con thumbnail + título + variant + qty.
 * Sobre fondo neutro para no distraer del producto al lado.
 */
