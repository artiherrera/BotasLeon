 ...
 *
 * - Global (sin `product`, montado en el layout): mensaje genérico.
 * - En el PDP (con `product`): mensaje contextual con nombre + link de la
 *   bota, para que quien atiende el chat sepa de inmediato el producto.
 *
