...
export const DICTIONARY: Record<string, Entry> = {
  ...
  "page.devoluciones.title": { es: "Cambios y devoluciones", en: "Exchanges & returns" },
  "page.devoluciones.intro": { es: "Nuestra política de cambio de talla y devolución, paso a paso.", en: "Our size-exchange and return policy, step by step." },
