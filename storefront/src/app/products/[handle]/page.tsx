 ...
 *
 * Server component que fetchea por handle. La interactividad
 * (selección de variante, add-to-cart) vive en <ProductOptions/>
 * que es client component. Hidratación selectiva — el grueso del
 * HTML se sirve estático, solo los controles necesitan JS.
 */
        ...
        <div className="mx-auto max-w-7xl px-6 py-8 md:py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="lg:sticky lg:top-24 lg:self-start">
              ...
              {/* Cliente: selector de talla/variante + add to cart */}
...
// Genera metadata dinámica por producto. Sprint C la enriqueceremos
// con Open Graph + JSON-LD para SEO/share.
